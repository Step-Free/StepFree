      ...
      <section className="container mx-auto px-6 py-16 flex flex-col-reverse md:flex-row items-center gap-10">
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            <Button className="w-full sm:w-[230px] h-[40px] text-sm sm:text-base px-4 py-2">
              Learn More About Us
            </Button>

            <Button variant="outline" className="w-full sm:w-[230px] h-[40px] text-sm sm:text-base px-4 py-2 flex items-center justify-center gap-2 whitespace-nowrap">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {services.map((card, index) => (
              ...
              >
                ...
                <Button variant="outline" className="text-sm sm:text-base px-5 py-2">
                  {card.btn} {card.arr}
                </Button>
              </div>
            ))}
