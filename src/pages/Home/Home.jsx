    ...
    <div className="bg-white">
      ...
      <section className="container mx-auto px-6 py-16 flex flex-col-reverse md:flex-row items-center gap-10 first">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl font-bold text-700 mb-6 leading-tight max-w-[500px] mx-auto md:mx-0 
               flex flex-col gap-1`}
          >
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            ...
            <button className="border border-gray-300 text-gray-600 px-4 py-2 rounded-lg hover:bg-blue-50 font-semibold text-[16px] sm:text-[18px] transition w-full sm:w-[230px] h-[40px] flex items-center justify-center gap-2 whitespace-nowrap">
  Explore Our Services <span className="text-gray-600 text-lg">→</span>
</button>
