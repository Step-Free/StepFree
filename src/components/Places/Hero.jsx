...
const Hero = ({ searchQuery, setSearchQuery, allPlaces }) => {
    ...
    return (
        <div className="w-full bg-gradient-to-b from-blue-50 to-white dark:from-blue-950 dark:to-gray-900 py-20 md:py-28 text-center relative">
            <div className="max-w-3xl mx-auto px-4">
                ...
                <div className="max-w-xl mx-auto relative text-left">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
                        value={searchQuery}
                        onChange={(e) => {
                        ...
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden">
                            {filteredDropdown.length > 0 ? (
                                filteredDropdown.map((place) => (
                                    ...
                                    >
                                        <img src={place.img} alt={place.title} className="w-10 h-10 rounded object-cover mr-3" />
